...
if ($today == 'Tuesday' or $today == 'Wednesday' or $today == 'Thursday' or $today == 'Friday' or $today == 'Saturday' ){
	...
	if( $rows['st'] == 1){
		...
		$reset = $reset ="UPDATE `sp` SET `sunday`='',`sunli`='0',`monday`='',`monli`='0',`tuesday`='',`tuesli`='0',`wednesday`='',`wednesli`='0',`thursday`='',`thursli`='0',`friday`='',`frili`='0',`saturday`='',`saturli`='0' , st = '0' , pr = '', tdate='' , ttime= '', o_sunday='', o_monday = '' , o_tuesday = '', 
		o_wednesday = '', o_thursday = '' , o_friday = '', o_saturday = '', fr = '',t_sunday='',t_monday='',t_tuesday='',t_wednesday='',t_thursday='',t_friday='',t_saturday='',t_from='',t_to='' , r_oracle = '', r_name = '' r_sv = '' ";
		$connt->query($reset);
